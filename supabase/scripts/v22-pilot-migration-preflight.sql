-- v22 Pilot Migration Preflight (READ-ONLY)
-- Run this in Supabase SQL Editor before creating/applying any v22 migration.
-- This script performs inventory, drift checks, and safety validation only.
...
-- =============================================================
-- 01. Expected Object Existence Matrix
-- =============================================================
...
-- =============================================================
-- 02. Relation Size and Estimated Rows (existing tables/views only)
-- =============================================================
SELECT
...
-- =============================================================
-- 03. Column Inventory for Core Tables
-- =============================================================
SELECT
...
-- =============================================================
-- 04. Targeted Services Column Presence (app + view dependencies)
-- =============================================================
...
-- =============================================================
-- 05. RLS Status for Public Tables
-- =============================================================
SELECT
...
-- =============================================================
-- 07. Grants on Key Objects
-- =============================================================
SELECT
  '07_grants' AS section,
  table_schema,
  table_name,
  grantee,
  privilege_type,
...
FROM pg_matviews
WHERE schemaname = 'public'
  AND matviewname IN ('mat_feedback_aggregations', 'mat_unmet_needs_summary')
ORDER BY matviewname;

-- =============================================================
-- 09. Function Inventory (security-definer + search_path)
-- =============================================================
SELECT
...
-- =============================================================
-- 10. Legacy Admin-Model Detection (user_metadata usage)
-- =============================================================
SELECT
...
-- =============================================================
-- 11. Core Referential/Data Integrity Checks
-- =============================================================
SELECT
...
WHERE c.table_schema = 'public'
  AND c.table_name = 'service_update_requests'
  AND c.column_name IN ('field_updates', 'updates')
...
-- =============================================================
-- 12. Pilot Table Readiness Snapshot
-- =============================================================
