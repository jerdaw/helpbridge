...
This script:
- Reads the existing batch files in docs/audits/v17-5/ai-results/batches to preserve ID order and grouping.
...
BATCH_PATHS = [
    ROOT / "docs" / "audits" / "v17-5" / "ai-results" / "batches" / "2026-01-21-v17-5-batch1.json",
    ROOT / "docs" / "audits" / "v17-5" / "ai-results" / "batches" / "2026-01-21-v17-5-batch2.json",
    ROOT / "docs" / "audits" / "v17-5" / "ai-results" / "batches" / "2026-01-21-v17-5-batch3.json",
    ROOT / "docs" / "audits" / "v17-5" / "ai-results" / "batches" / "2026-01-21-v17-5-batch4.json",
]
